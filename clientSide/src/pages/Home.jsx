          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                Streamlines scheduling, ensuring efficient allocation of resources and optimizing patient and staff time. By automating tasks, it enhances the overall patient experience, improving accessibility and reducing wait times.
                </p>
              ...
              <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 lg:gap-[30px]">
                ...
                <div>
                  ...
                  <p className="text__para">Number of Patient</p>
                </div>
                <div>
                  <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-headingColor">
                    90%
